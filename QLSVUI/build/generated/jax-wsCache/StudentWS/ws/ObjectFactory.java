...
public class ObjectFactory {
    ...
    private final static QName _FindStudent_QNAME = new QName("http://soap/", "findStudent");
    private final static QName _FindStudentResponse_QNAME = new QName("http://soap/", "findStudentResponse");
    ...
    /**
     * Create an instance of {@link FindStudent }
     * 
     */
    public FindStudent createFindStudent() {
        return new FindStudent();
    }

    /**
     * Create an instance of {@link FindStudentResponse }
     * 
     */
    public FindStudentResponse createFindStudentResponse() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindStudent }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap/", name = "findStudent")
    public JAXBElement<FindStudent> createFindStudent(FindStudent value) {
        return new JAXBElement<FindStudent>(_FindStudent_QNAME, FindStudent.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindStudentResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap/", name = "findStudentResponse")
    public JAXBElement<FindStudentResponse> createFindStudentResponse(FindStudentResponse value) {
        return new JAXBElement<FindStudentResponse>(_FindStudentResponse_QNAME, FindStudentResponse.class, null, value);
    }
